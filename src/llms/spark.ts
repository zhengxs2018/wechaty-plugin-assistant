...
import { SparkAPI, type SparkAPIOptions } from '../llmapi';
...
export class ChatSpark implements ChatModel {
  name: string = 'spark-api';

  human_name: string = '星火认知';
